...
- Backend architecture: configuration, models, controllers, middleware, utilities, and routes.
- Express middleware for JSON, cookies, and credentialed client CORS.
- Health endpoint and temporary responses for all planned API routes.
